...
import com.fastcode.emailtest2.addons.emailapi.domain.emailhistory.EmailHistoryRepository;
import com.fastcode.emailtest2.addons.emailapi.domain.emailhistory.EmailHistory;
...
public class EmailService implements IEmailService {
	...
	public void sendMessage(String to, String cc, String bcc, String subject, String htmlContent,
			List<FileEntity> inlineImages, List<FileEntity> attachments,Map<Long,byte[]> imageDataSourceMap) {
