package com.fastcode.emailtest2.addons.docmgmt.domain.file;
...
public interface IFileRepository extends JpaRepository<FileEntity, Long> ,QuerydslPredicateExecutor<FileEntity>, 
	...
	@Modifying
	@Transactional
	@Query("update  FileEntity u set u.deleted = true  where u.id not in (:ids) and u.emailTemplateId = :emailTemplateId ")
